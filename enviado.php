...
?>
    ...
    <section class="container-fluid pad_inl_0 overflow-hidden">
        ...
        <header class="center_r pad_inl_2 pad_block_1">
            ...
            <nav class="menu_1">
                <ul class="mar_0">
                    ...
                    <li>
                        <a href="colabora.html" class="active">Colabora</a> </li>
                    <li>
                ...
                <nav id="menu" class="menu">
                    <ul>
                        ...
                        <li>
                            <a href="conocenos.html">Conocenos</a> </li>
                        <li>
                            <a href="colabora.html" class="activo">Colabora</a> </li>
                        <li>
        ...
        <section id="main_colabora" class="center_r pad_block_10">
            <div class="sombra_top"></div>
            <div class="sombra_bottom"></div>
            <div id="particles-js"></div>
            <article class="col-10 col-lg-10 col-xl-6 center_c">
                <h1 class="box wow fadeInLeft">Ayudanos a revelar al poder con un solo click</h1>
            </article>

            <article class="col-12 col-lg-10 col-xl-6 center_c box wow fadeInDown">

                <iframe class="drop-shadow" width="80%" height="400px" src="https://www.youtube.com/embed/TGadKXAveqA"
        ...
        <section id="colabora" class="center_r pad_t_6">

            <div class="center_r pad_b_4">
                <article id="donar" class="col-12 col-md-10 col-lg-6 pad_4 center_r">

                    <h3 class="box wow fadeIn">Elegí cuánto querés donar</h3>

                    <div class="col-12 center_r pad_0 pad_b_1">
                        <div class="col-10 col-md-8 col-lg-4 pad_2 center_c box wow bounceIn b1">
                            <div class="drop-shadow">
                                <a class="boton" href="javascript:void(0)" mp-mode="dftl" name="MP-payButton"
                                    target="">ARS$100</a>
                            </div>
                        </div>

                        <div class="col-10 col-md-8 col-lg-4 pad_2 center_c box wow bounceIn b3">
                            <div class="">
                                <a class="boton" href="javascript:void(0)" mp-mode="dftl" name="MP-payButton"
                                    target="">ARS$300</a>
                            </div>
                        </div>
                        <div class="col-10 col-md-8 col-lg-4 pad_2 center_c box wow bounceIn b5">
                            <div class="">
                                <a class="boton" href="javascript:void(0)" mp-mode="dftl" name="MP-payButton"
                                    target="">ARS$500</a>
                            </div>
                    ...
                    <div class="col-12 otras_formas box wow fadeIn">
                        <a class="boton"
                            href="https://red.us18.list-manage.com/subscribe?u=8ba81c626e85d7f59b075d0ad&id=1b224e8b3f"
                            target="_blank">Otras
                            formas
                            de
                            colaborar</a>
                ...
                <article id="por_que_colaborar" class="col-12 col-md-10 col-lg-6 col-xl-4 pad_4 box wow fadeInRight">

                    <h2>¿Por qué colaborar con socios.red?</h2>
                    <div class="linea pad_t_1 mar_b_2"></div>
                    <p>Las investigaciones que facilita socios.red pueden resultar incómodas para los gobiernos y los
                        grandes
                        poderes económicos. Necesitamos tu ayuda para que nuestro trabajo no dependa de la voluntad de
                        otras
                        instituciones.</p>
        ...
        <article id="proceso" class="row pad_0 mar_0 center_r pad_t_10">
            <div class="sombra_top"></div>
            <h2 id="title_proceso" class="col-12 pad_b_2 mar_b_5 box wow fadeIn">¿Qué hacemos?</h2>

            <div class="col-10 col-sm-7 col-md-5 col-lg-2 pad_inl_2 pad_b_8 center_c box wow flipInX a3">
                <h2>1</h2>
                <img src="img/donacion1.svg" alt="">
                <div class="center_c">
                    <h4>Colaborá con
                        socios.red.</h4>
                    <div class="linea pad_t_2"></div>
                </div>
            </div>
            <div class="col-10 col-sm-7 col-md-5 col-lg-2 pad_inl_2 pad_b_8 center_c box wow flipInX a5">
                <h2>2</h2>
                <img src="img/chequeo1.svg" alt="">
                <div class="center_c">
                    <h4>Nosotros limpiamos
                        y conectamos los datos.</h4>
                    <div class="linea pad_t_2"></div>
                </div>
            </div>
            <div class="col-10 col-sm-7 col-md-5 col-lg-2 pad_inl_2 pad_b_8 center_c box wow flipInX a7">
                <h2>3</h2>
                <img src="img/juntos1.svg" alt="">
                <div class="center_c">
                    <h4>Armamos juntos el
                        identikit del poder.</h4>

                    <div class="linea pad_t_2"></div>
                </div>
            </div>
            <div class="col-10 col-sm-7 col-md-5 col-lg-2 pad_inl_2 pad_b_8 center_c box wow flipInX a9">
                <h2>4</h2>
                <img src="img/justa1.svg" alt="">
                <div class="center_c">
                    <h4>Creamos sociedades
                        más justas y transparentes.</h4>
                    <div class="linea pad_t_2"></div>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-8 col-xl-6">
                ...
                <<form class="col-12 center_r " action="enviado.php" method="post">
                    <div id="form_datos" class="col-12 col-md-6 pad_inl_1">
                        ...
                        <fieldset>
                            <input name="telefono" placeholder="Número de teléfono (opcional)" type="tel" tabindex="3">
                        </fieldset>
                        <fieldset>
